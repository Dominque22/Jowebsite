	...
	<div>
		<section>
			...
			<div class="navi">
				<Portfolio />
				<ul>
				<li><a href="Portfoli2o" style="text-decoration: none">About</a></li>
				<li><a href="<Portfolio/" style="text-decoration: none">Portfolio</a></li>
				<li><a href="" style="text-decoration: none">365</a></li>
				<li><a href="" style="text-decoration: none">Hi</a></li>
				</ul>
			</div>
		</section>
	</div>
...
.left-image{
  width: 30%;
  height: 400px;
  background: cyan no-repeat center /cover;
}
